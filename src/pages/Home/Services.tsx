            ...
            servicesData.map((data) => (
              <div className="flex flex-col border border-neutralSoftGray p-4 rounded-2xl h-full">
                ...
                <div className="space-y-2 mt-6 mb-4">
                  ...
                  <p className="text-xl text-end font-normal">
                    {data.desc}
                  </p>
                </div>
                <button className="w-full bg-primarySoft text-primaryDark border border-primaryMain rounded-lg px-4 py-2 cursor-pointer">
                  {data.btn}
                </button>
              </div>
            ))
