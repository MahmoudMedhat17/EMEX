...
const Ready = () => {
    ...
    return (
        <section dir={direction} style={{ "--bgImage": `url("/assets/ReadyStorageService.png")` } as React.CSSProperties} className="my-16 bg-ready-section h-[500px] w-full flex flex-col justify-center items-center overflow-hidden">
